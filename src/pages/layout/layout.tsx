      ...
      <Container >
          ...
          <Sidenav expanded={expand} appearance="subtle" style={{ height: '100%', overflow: '' }}>
            <Sidenav.Body style={{ flexGrow: 1, }}>
              <Nav defaultActiveKey="1" activeKey={activeKey} onSelect={(key) => setActiveKey(key)} >
                ...
                <Nav.Item eventKey="4" style={{ borderRadius: "10px" }} icon={<Icon as={FaShop} />} className={`navItem ${expand ? "" : "collapsed"} ${activeKey === "4" ? "active" : ""}`} onClick={() => navigate("/branchOffice")}>Sucursales</Nav.Item>
        ...
        <Container>
          ...
          <Container style={{ display: "flex", flexDirection: "row", flex: 60 }}>
            <Content style={{ flex: expandRight ? 0.75 : 1, marginLeft: "10px", marginRight: "10px", marginBottom: "10px", borderRadius: "20px" }}>
              {children}
            </Content>
